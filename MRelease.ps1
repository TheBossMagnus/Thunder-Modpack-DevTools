...
Set-Location "C:\Users\User\GitHub\Quilt-Optimized\bin"

#get most recent and second most recent version using folder creation date
$latest_version = $release  #get latest version
$secondlatest_version = (Get-ChildItem -Path "C:\Users\User\GitHub\Quilt-Optimized\bin" -Directory | Sort-Object LastWriteTime)[-2].Name   #get second latest version



$oldPack = "C:\Users\User\GitHub\Quilt-Optimized\bin\$secondlatest_version\quilt\Quilt Optimized-$secondlatest_version for quilt 1.19.4.mrpack"    #generate .mrpack of old version path

$newPack = "C:\Users\User\GitHub\Quilt-Optimized\bin\$latest_version\quilt\Quilt Optimized-$latest_version for quilt 1.19.4.mrpack"    #generate .mrpack of new version path


Write-Host "`n generating changelog from $secondlatest_version to $latest_version `n"
java -jar "C:\Users\User\GitHub\Modpack DevTools\ModListCreator.jar" changelog -old $oldPack -new $newPack -out "C:\Users\User\GitHub\Quilt-Optimized\bin\$latest_version\Changelog.md"   #generate changelog

#add to global changelog
$verchangelog = get-content "C:\Users\User\GitHub\Quilt-Optimized\bin\$latest_version\Changelog.md"    #get content current changelog
...
Set-Content "C:\Users\User\GitHub\Quilt-Optimized\Changelog.md" -Value ($verchangelog + $date + "---" + $globalchangelog)  #add current changelog to global changelog
